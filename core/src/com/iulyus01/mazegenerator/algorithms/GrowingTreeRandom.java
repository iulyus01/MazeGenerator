...
public class GrowingTreeRandom implements Algorithm {
    ...
    public GrowingTreeRandom(int mazeWidth, int mazeHeight) {
    ...
    synchronized public void create(int startX, int startY, int sleepTime) {
        ...
        while(!cellList.isEmpty()) {
            ...
            int rand = (int) (Math.random() * cellList.size());
            int x = cellList.get(rand).first;
            int y = cellList.get(rand).second;
            // end
            ...
            if(removeCell) cellList.remove(rand);
